...
if (isset($_GET['file'])) {
    ...
    $xml = simplexml_load_file("xmlfile/quiz1data.xml") or die("Error: Cannot load the default XML file.");
}
...
<body>
  ...
  <div id="editPopup" class="edit-popup">
    ...
    function openEditPage() {
        ...
        const xmlFilePath = <?php echo json_encode($filePath); ?>; // The path to the current XML file
