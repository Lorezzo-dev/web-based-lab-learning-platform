...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['grade'])) {
    ...
    // Prepare SQL statement to update module4_quiz_grade
    $sql = "UPDATE grades SET module4_quiz_grade = ? WHERE user_id = ?";
    ...
    // Prepare SQL statement to update module4quiz_completed to 1
    ...
    // Execute the update query
    if ($stmt->execute()) {
        echo "Module 4 quiz completion status updated successfully";
    } else {
...
$xml = simplexml_load_file('xmlfile/quiz4data.xml') or die("Error: Cannot load quiz data");
...
<head>
    ...
    .point-container {
        ...
        left: 80%; /* Center above the question */
    ...
    .option {
        min-height: 50px; /* Ensure options have consistent height */
    }

    #quiz-container {
        min-width: 600px; /* Set an appropriate minimum width */
        min-height: 400px; /* Set an appropriate minimum height */
        width: 80%; /* Ensure responsive design */
  ...
  <div id="editPopup" class="edit-popup">
      <div class="popup-content">
        ...
        <div id="quiz-container">
            ...
            <div id="results"><button id="proceed-button" class="lab-btn" onclick="proceedToLab()" style="display: none;">Go to Quarterly Assessment</button></div>
        </div>


    <div class="custom-prompt" id="customPrompt">
        <div class="prompt-content">
            <p>Do you want to start Quarterly Assessment?</p>
    ...
    function proceedToLab() {
        window.location.href = "quarterly.php"; // Replace with your module 2 page
    }

    function openEditPage() {
        const editPopup = document.getElementById('editPopup');
        const editIframe = document.getElementById('editIframe');
        const xmlFilePath = 'xmlfile/quiz4data.xml'; // The path to the current XML file
